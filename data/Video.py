...
class VideoFactory:
    ...
    @staticmethod
    def new_video(title: str, description: str, tags: str, size: int, length: int, views: int, like_count: int, cloudinary_id: int):
        return Video(title, description, tags, size, length, views, like_count, cloudinary_id)
